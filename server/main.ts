...
import { LiveCommentSettingsStore } from "./store/live-comment-settings.ts";
...
const liveCommentSettingsStore = new LiveCommentSettingsStore(kv);
...
// 実況連携設定 (取得元ごとのチャンネル → 実況チャンネル ID の割り当て)。
app.route(
